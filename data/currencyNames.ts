/**
 * English names + zero-decimal flags for every ISO 4217 code the live rates
 * provider returns, so currencies outside the bundled 33 still display nicely.
 * Names are proper nouns and stay in English (like city names).
 */
...
export const currencyNames: Record<string, string> = {
	...
	CAD: "Canadian Dollar", CDF: "Congolese Franc", CHF: "Swiss Franc", CLF: "Chilean Unit of Account",
	...
	FJD: "Fijian Dollar", FKP: "Falkland Islands Pound", FOK: "Faroese Króna", GBP: "British Pound",
	...
	KES: "Kenyan Shilling", KGS: "Kyrgyzstani Som", KHR: "Cambodian Riel", KID: "Kiribati Dollar",
	...
	MNT: "Mongolian Tögrög", MOP: "Macanese Pataca", MRU: "Mauritanian Ouguiya", MUR: "Mauritian Rupee",
	...
	PKR: "Pakistani Rupee", PLN: "Polish Złoty", PYG: "Paraguayan Guaraní", QAR: "Qatari Riyal",
	...
	SLL: "Sierra Leonean Leone (old)", SOS: "Somali Shilling", SRD: "Surinamese Dollar", SSP: "South Sudanese Pound",
	...
	TRY: "Turkish Lira", TTD: "Trinidad and Tobago Dollar", TVD: "Tuvaluan Dollar", TWD: "New Taiwan Dollar",
	...
	XCG: "Caribbean Guilder", XDR: "IMF Special Drawing Rights", XOF: "West African CFA Franc",
	XPF: "CFP Franc", YER: "Yemeni Rial", ZAR: "South African Rand", ZMW: "Zambian Kwacha",
	ZWG: "Zimbabwe Gold", ZWL: "Zimbabwean Dollar",
};

/** Currencies with no practical sub-unit — shown without decimals. */
export const zeroDecimalCurrencies = new Set([
	"BIF", "CLP", "DJF", "GNF", "HUF", "IDR", "IRR", "ISK", "JPY", "KMF", "KRW", "LAK", "LBP",
	"MGA", "MMK", "PYG", "RWF", "SLL", "SOS", "UGX", "UZS", "VND", "VUV", "XAF", "XOF", "XPF",
	"ARS", "COP", "TZS", "ZWL",
]);

export const currencySymbols: Record<string, string> = {
	CNY: "¥", CNH: "¥", HKD: "HK$", TWD: "NT$", PHP: "₱", ILS: "₪", NGN: "₦", UAH: "₴",
	RUB: "₽", KZT: "₸", GEL: "₾", LAK: "₭", KHR: "៛", MNT: "₮", PYG: "₲", CRC: "₡",
	NOK: "kr", RON: "lei", BGN: "лв", SAR: "SR", OMR: "OMR", KWD: "KD", BHD: "BD",
};
