import type { PhraseLanguageCode } from "@/data/phrases";
import type { TranslationKey } from "@/i18n/translations";

/**
 * Bundled destination & airport tips (Phase 2 content).
 *
 * Tip *text* is plain English string literals on purpose — this is offline
 * bundled content and is NOT routed through t()/useTranslation. City and
 * country names are proper nouns and stay untranslated. Tip *labels* are the
 * seven fixed categories below and ARE localized via `labelKey`.
 *
 * Single source of truth: `destinations` array + `getDestinationById()`.
 */

/** The seven fixed tip categories, each a translation key. */
export type DestinationTipLabelKey =
	| "destTipFromAirport"
	| "destTipGettingAround"
	| "destTipFood"
	| "destTipMoneyTipping"
	| "destTipEtiquette"
	| "destTipSafety"
...
export type DestinationTip = {
	...
	icon: string;
	/** Localized category label for the tip. */
	labelKey: DestinationTipLabelKey;
	/** 1–2 sentence practical advice (English). */
	text: string;
};
...
export type Destination = {
	...
	country: string;
	emoji: string;
	/** IANA time zone, e.g. "Asia/Tokyo" — used for local-time + jet-lag hints. */
	timezone: string;
	/** Standard-time UTC offset in minutes; fallback when Intl time zones are unavailable. */
	utcOffsetMinutes: number;
	/** Language of the bundled phrasebook for this destination. */
	phraseLanguage: PhraseLanguageCode;
	/** ISO 4217 code of the local currency — must exist in `data/currencies.ts`. */
	currencyCode: string;
	/** Extra checklist items shown as a "For {city}" section (translation keys). */
	checklistExtras?: TranslationKey[];
	tips: DestinationTip[];
};
...
export const destinations: Destination[] = [
	{
		...
		phraseLanguage: "ja",
		currencyCode: "JPY",
		checklistExtras: ["checklistItemIcCard", "checklistItemCashCountry", "checklistItemPowerAdapterJp"],
		city: "Tokyo",
		country: "Japan",
		emoji: "🗼",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "fr",
		currencyCode: "EUR",
		checklistExtras: ["checklistItemTransitCard", "checklistItemPowerAdapterEu"],
		city: "Paris",
		country: "France",
		emoji: "🗼",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "en",
		currencyCode: "USD",
		checklistExtras: ["checklistItemEsta", "checklistItemTippingCash", "checklistItemPowerAdapterUs"],
		city: "New York",
	...
	},
	{
		...
		phraseLanguage: "nl",
		currencyCode: "EUR",
		checklistExtras: ["checklistItemWaterproof", "checklistItemTransitCard", "checklistItemPowerAdapterEu"],
		city: "Amsterdam",
		country: "Netherlands",
		emoji: "🚲",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "ar",
		currencyCode: "AED",
		checklistExtras: ["checklistItemModestDress", "checklistItemSunscreen", "checklistItemPowerAdapterUk"],
		city: "Dubai",
	...
	},
	{
		...
		phraseLanguage: "th",
		currencyCode: "THB",
		checklistExtras: ["checklistItemTapWater", "checklistItemMosquito", "checklistItemModestDress"],
		city: "Bangkok",
		country: "Thailand",
		emoji: "🛕",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "en",
		currencyCode: "GBP",
		checklistExtras: ["checklistItemTransitCard", "checklistItemWaterproof", "checklistItemPowerAdapterUk"],
		city: "London",
	...
	},
	{
		...
		phraseLanguage: "en",
		currencyCode: "SGD",
		checklistExtras: ["checklistItemIcCard", "checklistItemPowerAdapterUk", "checklistItemSunscreen"],
		city: "Singapore",
		country: "Singapore",
		emoji: "🦁",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "tr",
		currencyCode: "TRY",
		checklistExtras: ["checklistItemModestDress", "checklistItemTransitCard", "checklistItemCashCountry"],
		city: "Istanbul",
		country: "Türkiye",
		emoji: "🕌",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "en",
		currencyCode: "AUD",
		checklistExtras: ["checklistItemEta", "checklistItemSunscreen", "checklistItemPowerAdapterAu"],
		city: "Sydney",
		country: "Australia",
		emoji: "🌉",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "is",
		currencyCode: "ISK",
		checklistExtras: ["checklistItemLayers", "checklistItemWaterproof", "checklistItemPowerAdapterEu"],
		city: "Reykjavík",
		country: "Iceland",
		emoji: "🌋",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "ko",
		currencyCode: "KRW",
		checklistExtras: ["checklistItemIcCard", "checklistItemPowerAdapterEu"],
		city: "Seoul",
		country: "South Korea",
		emoji: "🏙️",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "ar",
		currencyCode: "EGP",
		checklistExtras: ["checklistItemModestDress", "checklistItemCashCountry", "checklistItemTapWater"],
		city: "Cairo",
		country: "Egypt",
		emoji: "🐫",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "es",
		currencyCode: "MXN",
		checklistExtras: ["checklistItemTapWater", "checklistItemTippingCash"],
		city: "Mexico City",
		country: "Mexico",
		emoji: "🌮",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "en",
		currencyCode: "ZAR",
		checklistExtras: ["checklistItemSunscreen", "checklistItemPowerAdapterZa", "checklistItemTapWater"],
		city: "Cape Town",
	...
	},
	{
		...
		phraseLanguage: "id",
		currencyCode: "IDR",
		checklistExtras: ["checklistItemTapWater", "checklistItemMosquito", "checklistItemSunscreen"],
		city: "Denpasar (Bali)",
		country: "Indonesia",
		emoji: "🏝️",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "es",
		currencyCode: "ARS",
		checklistExtras: ["checklistItemCashCountry", "checklistItemPowerAdapterEu"],
		city: "Buenos Aires",
		country: "Argentina",
		emoji: "💃",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "en",
		currencyCode: "CAD",
		checklistExtras: ["checklistItemEta", "checklistItemPowerAdapterUs", "checklistItemLayers"],
		city: "Toronto",
		country: "Canada",
		emoji: "🍁",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "pt",
		currencyCode: "BRL",
		checklistExtras: ["checklistItemMosquito", "checklistItemSunscreen", "checklistItemCashCountry"],
		city: "Rio de Janeiro",
		country: "Brazil",
		emoji: "🏖️",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "vi",
		currencyCode: "VND",
		checklistExtras: ["checklistItemTapWater", "checklistItemMosquito", "checklistItemCashCountry"],
		city: "Hanoi",
		country: "Vietnam",
		emoji: "🛵",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "sv",
		currencyCode: "SEK",
		checklistExtras: ["checklistItemLayers", "checklistItemPowerAdapterEu"],
		city: "Stockholm",
		country: "Sweden",
		emoji: "⛴️",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "es",
		currencyCode: "PEN",
		checklistExtras: ["checklistItemTapWater", "checklistItemCashCountry"],
		city: "Lima",
		country: "Peru",
		emoji: "🦙",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "en",
		currencyCode: "CAD",
		checklistExtras: ["checklistItemEta", "checklistItemPowerAdapterUs", "checklistItemWaterproof"],
		city: "Vancouver",
		country: "Canada",
		emoji: "🏔️",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "ms",
		currencyCode: "MYR",
		checklistExtras: ["checklistItemPowerAdapterUk", "checklistItemMosquito", "checklistItemTapWater"],
		city: "Kuala Lumpur",
		country: "Malaysia",
		emoji: "🕌",
		tips: [
	...
	},
	{
		...
		phraseLanguage: "en",
		currencyCode: "USD",
		checklistExtras: ["checklistItemEsta", "checklistItemTippingCash", "checklistItemLayers"],
		city: "San Francisco",
		country: "United States",
		emoji: "🌉",
		tips: [
